...
public final class DoubleMatrix {
    ...
    /**
     * Override assertEquals so that two double matrices are being compared
     *
     * @param o the second DoubleMatrix whose 2D array we are comparing to
     * @return true or false, determined by whether or
     * not the 2D array instance variables of the two objects are identical
     */
    @Override
